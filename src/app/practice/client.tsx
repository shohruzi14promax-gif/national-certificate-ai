      ...
      <div className="dashboard-content">
        ...
        <section className="practice-wrap">
          ...
          {started && !done && q && <div className="exam-shell">
            ...
            <div className="question-card exam-question"><div className="question-meta"><span>{q.difficulty === 'easy' ? 'Oson' : q.difficulty === 'hard' ? 'Qiyin' : 'O‘rta'}</span><span>{Object.keys(answers).length} ta javob saqlangan</span></div><h1>{q.text}</h1>
